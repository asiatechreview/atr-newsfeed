...
const SEED_CATEGORIES = [
  ...
  { name: "Health", pattern: "\\b(health|healthcare|health care|biotech|biotechnology|pharma|pharmaceutical|hospital|hospitals|medical|drug|drugs|clinical trial|vaccine|wellness)\\b" },
